  ...
  return (
    <div className="w-full">
      ...
      <section className="md:hidden">
        <div className="mb-10 bg-[#eff1fe] rounded-lg max-w-[423px] py-[35px] px-[20px] sm:max-w-[480px] mx-auto flex flex-col items-center gap-10">
      ...
      <section className="hidden md:flex lg:hidden max-md:hidden">
        <div className="mb-32 bg-[#eff1fe] pt-[60px] px-[88px] pb-[76px] w-full rounded-lg mx-auto flex flex-col items-center gap-9 shadow-sm">
          <div className="flex flex-col justify-center ">
            <h2 className="text-[#40196D] leading-[42px] font-[900] text-[30px] mb-[32px] mx-auto text-center w-[300px]">
              The money app for Africans.
            </h2>
          ...
          <button className="bg-[#40196D] rounded-lg  text-white text-[13px] font-bold">
            Join Kuda
          </button>
        </div>
      </section>
      ...
      <section className="hidden lg:flex">
        <div className="mb-32 bg-[#eff1fe] w-full rounded-lg pl-[70px] pt-[70px] pr-[250px] h-[340px]  flex justify-between gap-9 shadow-sm relative overflow-hidden">
          {/* Left container */}
